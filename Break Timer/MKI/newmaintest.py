...
def start_bat():
    subprocess.call([r"E:\Python FYP\MKII\test.bat"])
...
class ScreenApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        for F in (StartPage, RunClock): # <------- add in pages here!!!!!
...
class StartPage(tk.Frame):      #This section is done i think
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text ="Use Timer", bg = "#f36766",
                            command=lambda: controller.show_frame(RunClock))
        button1.pack()
        button2 = tk.Button(self, text ="Close Application", bg = "#f36766",
                            command=quit)
        button2.pack()
        button2 = tk.Button(self, text ="About Timer Application", bg = "#f36766",
                            command=lambda:popupabout("AboutPage"))
        button2.pack()
...
class RunClock(tk.Frame): 
    ...
    def __init__(self, parent, controller):
        ...
        button5 = tk.Button(self, text ="Batch", bg = "#f36766",
                            command=start_bat)
        button5.pack() #This button is useless. will remove once batch file is called via countdown

        button1 = tk.Button(self, text ="Set Settings", bg = "#f36766",
                            command=lambda:popupsettings("Settings"))
        button1.pack()
        
        button2 = tk.Button(self, text ="Main Screen", bg = "#f36766",
                            command=lambda:controller.show_frame(StartPage)) #this button is done
        button2.pack()
